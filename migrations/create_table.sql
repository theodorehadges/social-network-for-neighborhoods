...
user_id int references userm(id) unique not null, created_on timestamp);
...
author int references userm(id), created_time timestamp, title varchar, body varchar, lat float, long float, in_reply_to_message_id int references thread_message(id));
