...
create table userm(id serial primary key , username varchar unique, password bytea, firstname varchar, lastname varchar, description varchar, photo varchar, email varchar, street varchar,
